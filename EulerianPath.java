...
public class EulerianPath {
    ...
    private static boolean statisfiesNecessaryAndSufficientConditions(Graph G) {
    ...
    private boolean certifySolution(Graph G) {
        ...
        if (hasEulerianPath() != statisfiesNecessaryAndSufficientConditions(G)) return false;
    ...
    public static void main(String[] args) {
        ...
        unitTest(G1, "Eulerian path");

        Graph G2 = GraphGenerator.eulerianCycle(V, E);
